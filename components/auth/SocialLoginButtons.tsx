export const SocialLoginButtons = () => {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button type="button" className="w-full py-3 flex items-center justify-center gap-1 bg-brand-light-gray border border-gray-600 rounded-full hover:bg-gray-700">
