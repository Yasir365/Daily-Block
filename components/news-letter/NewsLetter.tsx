...
export const Newsletter = () => {
    return (
        ...
        <div className="bg-[#2D2D2D] mt-8 p-6 md:p-12 rounded-2xl max-w-5xl mx-auto shadow-xl">
            <div className="flex flex-col md:flex-row md:gap-10 gap-4">
                ...
                <div className="md:w-1/2 text-white space-y-4">
                    ...
                    <h2 className="text-[27px] md:text-3xl font-bold leading-tight w-full">Stories and interviews</h2>
