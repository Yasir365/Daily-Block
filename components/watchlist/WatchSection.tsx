...
import WatchSectionList from './WatchSectionList'
...
const WatchSection = () => {
    return (
        <div className='flex flex-col gap-8 '>
            ...
            <WatchSectionList list={listData} text='Alex explained how ByBarter plans to scale aggressively yet sustainably:' heading='Scaling from 15,000 → 2M Users in 12 Months' />
            <div className='flex flex-col-reverse md:flex-row justify-between gap-6 '>
                <div className='flex flex-col gap-8'>

                    <WatchSectionList list={listData1} text='ByBarter is tackling inefficiencies in traditional systems like SWIFT and even competitors like Paxful:' heading='Faster, Cheaper Cross-Border Payments' />
                    <WatchSectionList list={listData2} text='ByBarter challenges the old paradigm where banks control your money:' heading='Self-Custodial Banking' />
                    <WatchSectionList list={listData} text='Alex explained how ByBarter plans to scale aggressively yet sustainably:' heading='Scaling from 15,000 → 2M Users in 12 Months' />
                </div>
                <div>
